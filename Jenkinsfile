pipeline {
   ...
   parameters {
     string(name: 'SERVICE_NAME', defaultValue: 'fleetman-api-gateway', description: 'Microservice name')
     string(name: 'ECR_REPO_NAME', defaultValue: 'fleetman-api-gateway', description: 'ECR repo name')
